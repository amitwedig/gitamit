...
$.ajax({
    ...
    success: function (data) {
        if(!data.Error){
            $('.show_alert').html(data.enqBtnText);
            $('#headingdText h2').html(data.hdText);
            $('#headingdText small').html(data.hdTagText);
        }
    }
});
...
$(".enq-cancel").click(function(event){
