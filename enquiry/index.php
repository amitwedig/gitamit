...
$query_for_adding_script1 = array(
	"script_tag"=>array(
		"event"=>"onload",
		"src"=>"http://dev.wedighq.com/shopify/quick_enquiry/js/jquery.colorbox.js"
		)
	);
$query_for_adding_script2 = array(
	"script_tag"=>array(
		"event"=>"onload",
...
$script_tag_added1 = shopify_call($token, $shop, "/admin/script_tags.json", $query_for_adding_script1, 'POST');
$script_tag_added2 = shopify_call($token, $shop, "/admin/script_tags.json", $query_for_adding_script2, 'POST');
echo "<pre>";
print_r($script_tag_added1);
echo "</pre>";
